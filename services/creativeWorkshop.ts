    ...
    return {
        ...
        contentBlocks: Array.isArray(raw.contentBlocks)
            ? raw.contentBlocks.map((block: any) => ({
                ...
                injectionTarget: ['manualWorldPrompt', 'manualRealmPrompt', 'openingExtraRequirement', 'imageWorkflow', 'referenceOnly'].includes(block?.injectionTarget) ? block.injectionTarget : undefined

...
const 末日模板池: 拍卖模板[] = [
    { 名称: '净水片', 类型: '消耗品', 品质: '良品', 描述: '可处理少量不洁水源，包装已经拆散分装。', 标签: ['净水物资', '营地刚需'], 价格: 900, 出现原因: ['一支搜救队从仓库带回净水片，分批放入市场。'] },
    { 名称: '罐头包', 类型: '消耗品', 品质: '凡品', 描述: '几罐未过期的高热量食品，罐身有磕碰。', 标签: ['食物', '硬通货'], 价格: 1200, 出现原因: ['便利店废墟被清空后，少量完整罐头流入营地。'] },
    { 名称: '手摇电筒', 类型: '杂物', 品质: '良品', 描述: '无需电池也能应急照明，握柄磨损明显。', 标签: ['照明工具', '夜行必备'], 价格: 760, 出现原因: ['废弃商场搜出的照明工具被市场拆包出售。'] },
    { 名称: '弩机组件', 类型: '武器', 品质: '上品', 描述: '静音远程武器的核心组件，适合避开感染群。', 标签: ['静音武器', '禁货'], 价格: 6200, 主线类型: '官府线', 出现原因: ['营地武器工坊丢了一批组件，随后在市场出现。'] },
...
const 无限流模板池: 拍卖模板[] = [
    { 名称: '急救针剂', 类型: '消耗品', 品质: '良品', 描述: '主神空间标准化急救针，可快速止血并恢复少量体力。', 标签: ['医疗物资', '主神兑换'], 价格: 500, 出现原因: ['主神商城库存刷新，基础急救针剂被大量兑换。'] },
    { 名称: '低级强化药水', 类型: '消耗品', 品质: '上品', 描述: '淡蓝色液体，服用后可小幅提升某项基础属性。', 标签: ['强化药剂', '主神兑换'], 价格: 3200, 出现原因: ['主神商城推出限时折扣，强化药水兑换量激增。'] },
    { 名称: '生存工具包', 类型: '杂物', 品质: '良品', 描述: '含绳索、打火石、急救毯和压缩口粮。', 标签: ['生存物资', '任务装备'], 价格: 800, 出现原因: ['新人轮回者集中采购，基础生存工具需求增加。'] },
    { 名称: '消音手枪', 类型: '武器', 品质: '上品', 描述: '加装消音器的半自动手枪，适合近距离无声清除。', 标签: ['现代武器', '主神兑换'], 价格: 4500, 出现原因: ['资深轮回者将用过的枪械挂入寄售区。'] },
    { 名称: '防弹背心', 类型: '防具', 品质: '上品', 描述: '轻量化防弹内衬，可抵御大部分常规弹药。', 标签: ['防护装备', '现代防具'], 价格: 3800, 出现原因: ['一支小队在现代恐怖片中回收了多余防具。'] },
    { 名称: '轮回者腕表', 类型: '饰品', 品质: '极品', 描述: '主神空间配发的多功能腕表，可查看任务进度和倒计时。', 标签: ['主神装备', '信息工具'], 价格: 12000, 出现原因: ['已完成多次任务的轮回者升级了设备，旧版腕表流入寄售。'] },
    { 名称: '基因锁抑制器', 类型: '消耗品', 品质: '极品', 描述: '可暂时压制基因锁开启后的身体崩溃，副作用未知。', 标签: ['基因锁辅助', '高级药剂'], 价格: 18000, 出现原因: ['主神商城限量发售，被少数精英轮回者抢购后转手。'] },
    { 名称: 'C级支线剧情卷轴', 类型: '消耗品', 品质: '极品', 描述: '承载一段C级支线剧情的凭证，可用于兑换高级强化。', 标签: ['支线剧情', '稀缺资源'], 价格: 25000, 出现原因: ['某轮回者完成隐藏任务后出售多余支线剧情凭证。'] },
    { 名称: '精神力恢复药剂', 类型: '消耗品', 品质: '上品', 描述: '银色小瓶，服用后可快速恢复精神力消耗。', 标签: ['精神力辅助', '消耗品'], 价格: 2800, 出现原因: ['精神系能力者清仓时将多余药剂挂入主神商城。'] },
    { 名称: '初级血统强化液', 类型: '消耗品', 品质: '绝世', 描述: '暗红色浓缩液体，可激活微量血统因子。', 标签: ['血统强化', '高级兑换'], 价格: 55000, 出现原因: ['主神商城高级区出现一批来路不明的血统强化液。'] },
    { 名称: '战术匕首', 类型: '武器', 品质: '良品', 描述: '紧凑型战术匕首，握柄缠有防滑胶带。', 标签: ['近战武器', '基础装备'], 价格: 600, 出现原因: ['新人轮回者淘汰的入门武器被批量回收出售。'] },
    { 名称: '防护服', 类型: '防具', 品质: '良品', 描述: '轻便防护服，可抵御一定程度的物理和化学伤害。', 标签: ['防护装备', '任务刚需'], 价格: 1500, 出现原因: ['恐怖片任务结束后，大量防护服被低价回收。'] },
];
...
const 过滤题材拍卖模板 = (mode?: 拍卖题材模式): 拍卖模板[] => {
    ...
    if (profile.group === 'infinite') return 无限流模板池;
    return 模板池;
};

...
const 创建默认主神商城商品 = (): 详细门派结构['兑换列表'] => ([
    { id: 'infinite_shop_hemostatic_spray', 物品名称: '止血喷雾', 类型: '医疗补给', 兑换价格: 80, 库存: 8, 要求职位: '新人' },
    { id: 'infinite_shop_basic_armor', 物品名称: '轻型防弹内衬', 类型: '防护装备', 兑换价格: 160, 库存: 4, 要求职位: '新人' },
    { id: 'infinite_shop_silenced_pistol', 物品名称: '消音手枪', 类型: '现代武器', 兑换价格: 450, 库存: 2, 要求职位: '正式队员' },
    { id: 'infinite_shop_gene_lock_stabilizer', 物品名称: '基因锁稳定剂', 类型: '血统强化', 兑换价格: 1200, 库存: 1, 要求职位: '资深者' },
    { id: 'infinite_shop_horror_intel', 物品名称: '恐怖片情报片段', 类型: '支线情报', 兑换价格: 300, 库存: 3, 要求职位: '正式队员' }
] as any);
...
export const 创建开局门派状态 = (
    ...
    const normalized = 规范化门派状态({
        ...
        弟子总数: seedData.total,
        兑换列表: isApocalypse ? 创建默认营地物资列表() : isInfinite ? 创建默认主神商城商品() : isModern ? 创建默认现代组织资源列表() : isXianxia ? 创建默认仙侠聚宝阁商品() : 创建默认聚宝阁商品(),

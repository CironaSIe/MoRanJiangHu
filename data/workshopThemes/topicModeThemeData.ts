...
export const 题材模式配置表: Record<题材模式类型, 题材模式配置> = {
    ...
    仙侠: {
        ...
        manualRealmPrompt: '境界体系：练气、筑基、金丹、元婴、化神。每个大境界分初期/中期/后期/圆满；突破需要资源、心境、功法契合与风险。',
    ...
    无限流: {
        ...
        worldDefaults: {
            ...
            worldExtraRequirement: '本局为无限流：外部市场入口必须称为主神商城，团队内部兑换页可称为团队商城；核心货币是奖励点，关键高级兑换还需要D/C/B/A/S级支线剧情；任务奖励由主神按主线任务、支线任务、存活、击杀或隐藏贡献结算。不得把经济写成银子、灵石、人民币或门派贡献。'
        },
        worldSizeLabel: '轮回规模',
        ...
        auctionName: '主神商城',
        marketVerb: '进入主神兑换列表',
        currencyPrompt: '外部市场、强化、修复、造人和高级物资交易通过主神商城结算；团队内部补给和成员共享兑换可称为团队商城。基础货币为奖励点，高级项目必须消耗对应等级支线剧情；不要使用银子、铜钱、灵石、人民币或门派贡献。',
